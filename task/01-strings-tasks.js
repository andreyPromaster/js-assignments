...
function getCardId(value) {
    ...
    if (suit == '0'){suit = value.charAt(2)}
    let number = value.charAt(0);

    if (suit == '♣'){displacement +=0;}
    else if (suit == '♦'){displacement +=13;}
    else if (suit == '♥'){displacement +=26;}
    else  {displacement += 39;}

    if (number == "J"){number = 11;}
    else if (number == 'Q'){number = 12;}
    else if (number == 'K'){number = 13;}
    else if (number == 'A'){number = 1;}
    else if (number == '1'){number = 10;}
    else{number = Number.parseInt(number);}

    return number + displacement -1;
}
